...
def load_hepmass_dataset(rand_state):
    ...
    train_filepath = os.path.join(os.environ['DATAPATH'], 'datasets/hepmass/1000_train.csv')
    test_filepath = os.path.join(os.environ['DATAPATH'], 'datasets/hepmass/1000_test.csv')
    data_train = pd.read_csv(train_filepath, index_col=False)
    data_test = pd.read_csv(test_filepath, index_col=False)
