...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--sum-channels', type=int, default=2,
        help='The number of sum channels for each sum layer.'
    )
    parser.add_argument(
        '--depthwise', action='store_true',
        help='Whether to use depthwise product convolution layers.'
    )
    parser.add_argument(
        '--n-pooling', type=int, default=0,
        help='The number of initial pooling deepthwise product convolution layers.'
    )
    parser.add_argument(
