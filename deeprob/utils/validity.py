import numpy as np
from deeprob.structure.node import Sum, Mul
from deeprob.structure.cltree import BinaryCLTree
from deeprob.utils.filter import get_nodes, filter_nodes_type
