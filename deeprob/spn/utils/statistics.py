...
from deeprob.spn.structure.node import bfs, Sum, Mul
...
def get_statistics(root):
    ...
    stats = {
        ...
        'n_sum': len(filter_nodes_type(root, Sum)),
        'n_mul': len(filter_nodes_type(root, Mul)),
        'n_leaves': len(filter_nodes_type(root, Leaf)),
        'n_edges': get_edges_count(root),
        'n_params': get_parameters_count(root),
